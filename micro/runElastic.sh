...
docker run -d -it --net=micro_mynetwork --name logm -p 5044:5044 -vvv -e xpack.monitoring.enabled=true -e xpack.monitoring.elasticsearch.hosts=127.0.0.1:9200 docker.elastic.co/logstash/logstash:6.5.2 && \
